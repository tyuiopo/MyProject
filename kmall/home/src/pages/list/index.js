...
var page = {
	...
	loadProductList:function(){//加载商品列表
		var _this = this;
		_this.listParam.keyword ? (delete _this.listParam.categoryId) : (delete _this.listParam.keyword);
		_product.getProductList(_this.listParam,function(result){
			// console.log(result)
